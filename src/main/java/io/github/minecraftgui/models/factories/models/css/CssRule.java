...
import io.github.minecraftgui.models.components.ComponentEditableText;
import io.github.minecraftgui.models.components.ComponentText;
...
public class CssRule {
    ...
    public void addDeclaration( String declaration ) {
        ...
        switch ( attribute ) {
            case "text-cursor-color":
                declarations.add( new TextCursorColor( shape, state, split[1].trim() ) );
                break;
            case "text-nb-line":
                declarations.add( new TextNbLine( shape, state, split[1].trim() ) );
                break;
            case "text-alignment":
                declarations.add( new TextAlignment( shape, state, split[1].trim() ) );
                break;
            case "font":
                declarations.add( new Font( shape, state, split[1].trim() ) );
                break;
            case "font-color":
                declarations.add( new FontColor( shape, state, split[1].trim() ) );
                break;
            case "font-size":
                declarations.add( new FontSize( shape, state, split[1].trim() ) );
                break;
            case "width":
                declarations.add( new Width( shape, state, split[1].trim() ) );
                break;
            case "height":
                declarations.add( new Height( shape, state, split[1].trim() ) );
                break;
            case "x-relative":
                declarations.add( new XRelative( shape, state, split[1].trim() ) );
                break;
            case "y-relative":
                declarations.add( new YRelative( shape, state, split[1].trim() ) );
                break;
            case "x-position":
                declarations.add( new PositionX( shape, state, split[1].trim() ) );
                break;
            case "y-position":
                declarations.add( new PositionY( shape, state, split[1].trim() ) );
                break;
            case "visibility":
                declarations.add( new Visibility( shape, state, split[1].trim() ) );
                break;
            case "cursor":
                declarations.add( new Cursor( shape, state, split[1].trim() ) );
                break;
            case "positions":
                declarations.add( new Positions( shape, state, split[1].trim() ) );
                break;
            case "background-color":
                declarations.add( new BackgroundColor( shape, state, split[1].trim() ) );
                break;
            case "background-image":
                declarations.add( new BackgroundImage( shape, state, split[1].trim() ) );
                break;
            case "margin":
