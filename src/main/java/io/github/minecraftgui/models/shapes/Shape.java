...
public abstract class Shape<V> {
    ...
    public void setPadding(State state, Padding padding, double value) {
        String p = "";
        switch (padding){
            case BOTTOM: p = NetworkController.PADDING_BOTTOM; break;
            case TOP: p = NetworkController.PADDING_TOP; break;
            case LEFT: p = NetworkController.PADDING_LEFT; break;
            case RIGHT: p = NetworkController.PADDING_RIGHT; break;
        }
    ...
    public void setBorder(State state, Border border, double value) {
        String b = "";
        switch (border){
            case BOTTOM: b = NetworkController.BORDER_BOTTOM; break;
            case TOP:  b = NetworkController.BORDER_TOP; break;
            case LEFT:  b = NetworkController.BORDER_LEFT; break;
            case RIGHT:  b = NetworkController.BORDER_RIGHT; break;
        }
    ...
    public void setBorderColor(State state, Border border, Color value) {
        String b = "";
        switch (border){
            case BOTTOM: b = NetworkController.BORDER_BOTTOM_COLOR; break;
            case TOP:  b = NetworkController.BORDER_TOP_COLOR; break;
            case LEFT:  b = NetworkController.BORDER_LEFT_COLOR; break;
            case RIGHT:  b = NetworkController.BORDER_RIGHT_COLOR; break;
        }
